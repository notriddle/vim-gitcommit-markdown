...
" License:    VIM License
"
" Based on `gitcommit.vim` by Tim Pope <vimNOSPAM@tpope.org>
...
syn match   gitcommitSummary    "^.\{0,50\}" contained containedin=gitcommitFirstLine nextgroup=gitcommitOverflow contains=@markdown
